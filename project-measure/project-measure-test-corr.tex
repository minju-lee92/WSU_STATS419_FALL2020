...
\NormalTok{final.measure \textless{}{-}}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(path.project,}\StringTok{\textquotesingle{}final.measure.rds\textquotesingle{}}\NormalTok{))}
\NormalTok{myData =}\StringTok{ }\KeywordTok{as.matrix}\NormalTok{(final.measure[,}\KeywordTok{c}\NormalTok{(}\DecValTok{3}\OperatorTok{:}\DecValTok{7}\NormalTok{,}\DecValTok{20}\OperatorTok{:}\DecValTok{28}\NormalTok{)]);  }\CommentTok{\# numeric values only, only what will appear in table}
