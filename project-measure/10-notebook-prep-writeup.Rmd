...
# put in the same "units"   //DONE
# merge left/right          //DONE
# build proportion data     //DONE  
#  
...
```
```{r data_cleaning}
#set some of the attributes as factor
...
measure$writing[measure$writing=="\"right\""]= "right"
measure$eye = factor(tolower(measure$eye));
measure$eye[measure$eye=="\"right\""]= "right"
measure$eye[measure$eye=="\"left\""]= "left"
measure$eye[measure$eye=="equal"|measure$eye=="\"both\""]= "both"
measure$eye_color = factor(tolower(measure$eye_color));
measure$eye_color[measure$eye_color=="\"brown\""]= "brown"
measure$eye_color[measure$eye_color=="\"blue\""]= "blue"
measure$eye_color[measure$eye_color=="blue/green"]= "blue-green"
measure$ethnicity = factor(tolower(measure$ethnicity));
measure$ethnicity[measure$ethnicity=="asain" |measure$ethnicity =="\"asian\""]= "asian"
measure$ethnicity[measure$ethnicity=="caucasain"|measure$ethnicity=="caucasian"|measure$ethnicity=="\"caucasian\""]= "white"
measure$gender = factor(tolower(measure$gender));
measure$gender[measure$gender=="f" | measure$gender=="\"female\""] = "female";
measure$gender[measure$gender=="m" | measure$gender=="\"male\""] = "male";



measure$swinging = factor(tolower(measure$swinging));
measure$swinging[measure$swinging=="\"right\""| measure$swinging=="rigth"] = "right";
measure$swinging[measure$swinging=="\"left\""| measure$swinging=="leftt"| measure$swinging == "let"] = "left";
measure$side = factor(tolower(measure$side));

measure$units = factor(tolower(measure$units));
measure$units[measure$units=="inches"|measure$units=="inch"|measure$units=="\"in\""] = "in";
# remember conv_units ...
...
Q:Are the proportions differ between male and female.
