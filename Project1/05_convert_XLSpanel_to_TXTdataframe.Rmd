...
path.measure = "C:/_git_/WSU_STATS419_Fall2020/WEEK-00";  
...
path.your.measure.file = "C:/_git_/WSU_STATS419_Fall2020/WEEK-00";  
  # change this to wherever measure.xls lives for you...  
  # YOU SHOULD USE MINE IN THE DROPBOX AS THE EXAMPLE...
  # BELOW, we will import yours ...
...
for(i in 1:n.cov)
  ...
  colnames(final.row) = tabularized.cols;  #assigning col names
