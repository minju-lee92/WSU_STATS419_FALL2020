---
title: 'R Notebook: Workspace Audit for [Minju Lee]'
output:
  html_document:
    df_print: paged
    toc: true
...
```{r}
wsu.id = "11638071"; # change this to yours.
github.repository = "minju-lee92/WSU_STATS419_FALL2020";
...
<IMG src='workspaceAudit.images/github-code-frequency.png' style="border: 2px black solid;" />
<div>**Source: <a href="https://github.com/minju-lee92/WSU_STATS419_FALL2020/graphs/code-frequency">GitHub</a>**</div>
...
<IMG src='workspaceAudit.images/github-commits.png' style="border: 2px black solid;" />
<div>**Source: <a href="https://github.com/minju-lee92/WSU_STATS419_FALL2020/graphs/commit-activity">GitHub</a>**</div>
...
<IMG src='workspaceAudit.images/dropbox.png' style="border: 2px black solid;" />
...
<IMG src='workspaceAudit.images/git.png' style="border: 2px black solid;" />
<div>**Source: LOCAL COMPUTER**</div>
...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
  I have installed GitHub and sandbox at the beginning of the semester. I have been pushing it to GitHub about five times each month on average, and I have committed a total of 27 times to my remote repository. I tend to update my repository on Fridays and Mondays between 1 to 2 in the afternoon. I have updated my local sandbox frequently to catch up with the changes in the course. However, I could improve further on my workspace organization skills. Throughout the class, I have learned and familiarize myself with using Git GUI and Git Bash, which was new to me. I can say that I am confident at using GitHub, and I prefer it more than other repositories such as GitLab.  
	In conclusion, I want to point out that although my workspace practice wasn't perfect, I have put in the time to make sure to keep my workspace updated and as organized as possible. I have definitely improved on my workspace practice compare to the beginning of this semester. Therefore, I would give the full 50 points on the workspace audit. 
</pre>
